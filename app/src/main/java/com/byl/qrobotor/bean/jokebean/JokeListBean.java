...
public class JokeListBean {
    ...
    public static class Group {
        private String text;
        private DisLikeReason dislike_reason;
        ...
        public DisLikeReason getDislike_reason() {
            return dislike_reason;
        }

        public void setDislike_reason(DisLikeReason dislike_reason) {
    ...
    public static class JokeActivity {

    }

    public static class JokeVideo {
        private Video_360 video_360;
        private String mp4Url;//mp4格式视频链接
        private String text;
        private Video_720 video_720;
        private int digg_count;
        private double duration;
        private Video_480p video_480;
        private double create_time;
        private double go_detail_count;
        private String keywords;
        private double id;
        private int favorite_count;
        private Danmaku_attrs danmaku_attrs;
        private String m3u8_url;
        private Large_cover large_cover;//视频封面绝对路径
        private int user_favorite;
        private int share_type;
        ...
        private int comment_count;
        private String cover_image_uri;//视频封面相对路径
        private String id_str;
        private int media_type;
        private int share_count;
        private int type;
        ...
        private int user_repin;
        private Medium_cover medium_cover;
        private int user_digg;
        ...
        private int has_hot_comments;
        private boolean allow_dislike;
        private Origin_video origin_video;
        ...
        public Video_360 getVideo_360() {
            return video_360;
        }

        public void setVideo_360(Video_360 video_360) {
            this.video_360 = video_360;
        }
        ...
        public Video_720 getVideo_720() {
            return video_720;
        }

        public void setVideo_720(Video_720 video_720) {
            this.video_720 = video_720;
        }
        ...
        public Video_480p getVideo_480() {
            return video_480;
        }

        public void setVideo_480(Video_480p video_480) {
            this.video_480 = video_480;
        }
        ...
        public double getGo_detail_count() {
            return go_detail_count;
        }

        public void setGo_detail_count(double go_detail_count) {
            this.go_detail_count = go_detail_count;
        }
        ...
        public Danmaku_attrs getDanmaku_attrs() {
            return danmaku_attrs;
        }

        public void setDanmaku_attrs(Danmaku_attrs danmaku_attrs) {
        ...
        public Large_cover getLarge_cover() {
            return large_cover;
        }

        public void setLarge_cover(Large_cover large_cover) {
        ...
        public Medium_cover getMedium_cover() {
            return medium_cover;
        }

        public void setMedium_cover(Medium_cover medium_cover) {
        ...
        public Origin_video getOrigin_video() {
            return origin_video;
        }

        public void setOrigin_video(Origin_video origin_video) {
    ...
    private static class Video_360 {

    }

    private static class Video_720 {

    }

    private static class Video_480p {

    }

    private static class Danmaku_attrs {

    }

    private static class Large_cover {

    }

    private static class Medium_cover {

    }

    private static class Origin_video {
