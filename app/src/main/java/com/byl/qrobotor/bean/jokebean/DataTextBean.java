...
public class DataTextBean {
    private boolean has_more;
    private String tip;
    private boolean has_new_message;
    private double max_time;
    private double min_time;
    private List<InnerDataTextGroupBean> data;
    ...
    public List<InnerDataTextGroupBean> getData() {
        return data;
    }

    public void setData(List<InnerDataTextGroupBean> data) {
        this.data = data;
    }
}
