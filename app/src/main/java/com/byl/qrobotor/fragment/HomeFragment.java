...
public class HomeFragment extends BaseFragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        String[] idArray = mContext.getResources().getStringArray(R.array.news_type_id);
        for (String id : idArray) {
            mFragmentList.add(ContentFragment.newInstance(id));
        }
        String[] titleArray = mContext.getResources().getStringArray(R.array.news_type_tname);
        ...
        mCommonNavigator.setLeftPadding(10);
